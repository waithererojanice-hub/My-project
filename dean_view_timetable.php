...
// Updated query (removed department_id)
$query = "
SELECT c.course_name, u.unit_name, r.room_name,
       s.semester_name, t.day_of_week, t.start_time, t.end_time
FROM timetables t
...
<head>
  <meta charset='UTF-8'>
  <title>Dean View Timetable</title>
  <style>
    ...
    a.back { display: inline-block; margin-top: 20px; padding: 10px 15px; background: #6a1b9a; color: white; border-radius: 5px; text-decoration: none; }
    a.back:hover { background: #4a0072; }
  </style>
</head>
<body>
  ...
  <table>
    <tr>
      <th>Course</th><th>Unit</th><th>Room</th><th>Semester</th><th>Day</th><th>Start</th><th>End</th>
    </tr>
